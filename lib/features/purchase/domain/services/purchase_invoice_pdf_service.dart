...
class PurchaseInvoicePdfService {
  ...
  static pw.Page _buildPosPage(PurchaseInvoice invoice, PdfPageFormat format) {
    return pw.Page(
      pageFormat: format,
  ...
  static pw.Widget _buildHeader(PurchaseInvoice invoice, {bool isA6 = false}) {
    return pw.Row(
      ...
      children: [
        ...
        pw.Column(
          ...
          children: [
            ...
            if (invoice.vendorBillNo != null &&
                invoice.vendorBillNo!.isNotEmpty)
              pw.Text(
                'Vendor Bill No: ${invoice.vendorBillNo}',
          ...
          child: pw.Container(
            ...
            child: pw.Column(
              children: [
                ...
                if (invoice.cgst > 0)
                  _buildTotalRow('CGST:', invoice.cgst, baseFontSize),
                if (invoice.sgst > 0)
                  _buildTotalRow('SGST:', invoice.sgst, baseFontSize),
                if (invoice.igst > 0)
                  _buildTotalRow('IGST:', invoice.igst, baseFontSize),
